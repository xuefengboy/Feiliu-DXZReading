...
public class NotiListAdapter extends BaseAdapter {
	...
	public NotiListAdapter(Context context, List<String> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(position==0 || position==1){
			vi= convertView;
			if (vi == null) {
				vi = inflater.inflate(R.layout.notiitem_header, null);
				viewHolder2 = new ViewHolder2();
				viewHolder2.item_des = (TextView) vi.findViewById(R.id.notiheader_des);
				viewHolder2.item_left = (ImageView) vi.findViewById(R.id.notiheader_left_iv);
				vi.setTag(viewHolder2);

			} else {
				viewHolder2 = (ViewHolder2) vi.getTag();
			}
			if(position==0){
				viewHolder2.item_des.setText("新的粉丝");
				viewHolder2.item_left.setBackgroundResource(R.drawable.noti_newfensi);
			}else{
				viewHolder2.item_des.setText("群消息");
				viewHolder2.item_left.setBackgroundResource(R.drawable.noti_newmessage);
			}
			//return vi;
			...
			vi = convertView;
			if (vi == null) {
				vi = inflater.inflate(R.layout.notiitem, null);
				viewHolder = new ViewHolder();
				viewHolder.item_name = (TextView) vi.findViewById(R.id.noti_name);
				viewHolder.item_des = (TextView) vi.findViewById(R.id.noti_des);
				viewHolder.item_date = (TextView) vi.findViewById(R.id.noti_date);
				viewHolder.item_left = (ImageView) vi.findViewById(R.id.noti_left_iv); // 缩略图路径
				viewHolder.item_right = (ImageView) vi.findViewById(R.id.noti_right_iv);
				vi.setTag(viewHolder);

			} else {
				viewHolder = (ViewHolder) vi.getTag();
			}
			viewHolder.item_name.setText(list.get(position-2));
			viewHolder.item_des.setText("读心者免费赠送1200张《福尔摩斯》电影票");
			viewHolder.item_date.setText(CommonUtil.getStringDate2());
