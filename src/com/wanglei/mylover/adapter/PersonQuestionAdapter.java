...
public class PersonQuestionAdapter extends BaseAdapter {
	...
	public PersonQuestionAdapter(Context context, List<String> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View vi = convertView;
		if (vi == null) {
			vi = inflater.inflate(R.layout.questionitem, null);
			viewHolder = new ViewHolder();
			viewHolder.item_des = (TextView) vi.findViewById(R.id.image_tu_des); 
			viewHolder.item_img = (ImageView) vi.findViewById(R.id.image_tu); 
			vi.setTag(viewHolder);

		} else {
			viewHolder = (ViewHolder) vi.getTag();
		}
		viewHolder.item_des.setText((String) list.get(position));
		imageLoader.DisplayImage(URLS[new Random().nextInt(20)], viewHolder.item_img, false);
		return vi;
	}
