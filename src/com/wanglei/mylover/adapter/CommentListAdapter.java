...
public class CommentListAdapter extends BaseAdapter {
	...
	public CommentListAdapter(Context context, List<String> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		imageLoader.DisplayImage(URLS[position+new Random().nextInt(5)], viewHolder.item_left, false);
		imageLoader.DisplayImage(URLS[position+new Random().nextInt(6)], viewHolder.item_right, false);
		return vi;
	}
